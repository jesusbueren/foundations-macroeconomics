...
%}
% Comment out the next command to PRINT
%\documentclass[handout,10pt]{beamer}  % The <handout> and <trans> options allow to get a handout
                                       % version. It is better to complement it by commenting the
                                       % active theme so that no headers and footers are shown
...
% Packages and macros to underline nicely
% See: https://alexwlchan.net/2017/10/latex-myulines/
...
% -----------------------------------------------------------------------------
% -- My own standard commands for presentations -------------------------------
% -----------------------------------------------------------------------------

\newcommand{\vsoo}{\vspace{0.125cm}}
\newcommand{\vso}{\vspace{0.25cm}}
\newcommand{\vsi}{\vspace{0.50cm}}
\newcommand{\vsii}{\vspace{0.75cm}}
\newcommand{\vsiii}{\vspace{1.00cm}}
\newcommand{\nvsoo}{\vspace{-0.125cm}}
\newcommand{\nvso}{\vspace{-0.25cm}}
\newcommand{\nvsi}{\vspace{-0.50cm}}
\newcommand{\nvsii}{\vspace{-0.75cm}}
...
\newcommand{\hsoo}{\hspace{0.125cm}}
\newcommand{\hso}{\hspace{0.25cm}}
\newcommand{\hsi}{\hspace{0.50cm}}
\newcommand{\hsii}{\hspace{0.75cm}}
\newcommand{\hsiii}{\hspace{1.00cm}}
\newcommand{\hsiv}{\hspace{1.25cm}}
\newcommand{\hsv}{\hspace{1.50cm}}
\newcommand{\nhsoo}{\hspace{-0.125cm}}
\newcommand{\nhso}{\hspace{-0.25cm}}
\newcommand{\nhsi}{\hspace{-0.50cm}}
...
\newcommand{\itemnvsi}{\nvsi\item}
\newcommand{\itemnvsii}{\nvsii\item}
\newcommand{\itemnvsiii}{\nvsiii\item}

\newcommand{\itemvsoo}{\vsoo\item}
\newcommand{\itemvso}{\vso\item}
\newcommand{\itemvsi}{\vsi\item}
\newcommand{\itemvsii}{\vsii\item}
\newcommand{\itemvsiii}{\vsiii\item}

\newcommand{\implieso}{ \Rightarrow }
\newcommand{\impliesi}{ \ \Rightarrow \  }
\newcommand{\impliesii}{ \ \ \Rightarrow \ \ }
\newcommand{\impliesiii}{ \ \ \ \Rightarrow \ \ \ }

\newcommand{\nl}{\newline}
\newcommand{\kk}{\hspace*{0.3cm}}
\DeclareMathOperator*{\plim}{plim}

% Latex colors: https://latexcolor.com

\definecolor{vdarkblue}{rgb}{0.00,0.20,0.70} % Similar to colours in subsection
\definecolor{darkblue}{rgb}{ 0.00,0.20,0.70} 
\definecolor{myblue}{rgb}{0.65,0.65,1.00}
\definecolor{steelblue}{RGB}{70, 130, 180}
\definecolor{luigiblue}{RGB}{71, 116, 159}
\definecolor{navyblue}{rgb}{0.0, 0.0, 0.55}
\definecolor{cobalt}{rgb}{0.0, 0.28, 0.67}
\definecolor{ceruleanblue}{rgb}{0.16, 0.32, 0.75}
\definecolor{blueviolet}{RGB}{62, 38, 167}

\definecolor{vdarkgreen}{rgb}{0.00,0.40,0.00}
\definecolor{darkgreen}{rgb}{0.00,0.50,0.00}
\definecolor{mygreen}{rgb}{0.65,1.00,0.65}
\definecolor{green2}{rgb}{0.4660, 0.6740, 0.1880}
\definecolor{calpolypomonagreen}{rgb}{0.12, 0.3, 0.17}

\definecolor{vdarkred}{rgb}{0.50,0.00,0.00}
\definecolor{darkred}{rgb}{0.80,0.00,0.00}
\definecolor{myred}{rgb}{1.00,0.65,0.65}
\definecolor{red2}{rgb}{0.8500,0.3250,0.0980}

\definecolor{vdarkgray}{gray}{0.40}
\definecolor{darkgray}{gray}{0.60}
\definecolor{myyellow}{rgb}{1.00,1.00,0.70}
\definecolor{yellow2}{rgb}{0.9290,0.6940 ,0.1250}

\colorlet{finsburyblue}{cobalt!100}
\colorlet{emphblue}{myblue!30}


\newcommand{\fbluetext}{\textcolor{finsburyblue}}
\newcommand{\bluetext}{\textcolor{finsburyblue}}
\newcommand{\greentext}{\textcolor{darkgreen}}
\newcommand{\bibliotext}{\textcolor{vdarkgreen}}
\newcommand{\redtext}{\textcolor{red2}}
\newcommand{\graytext}{\textcolor{vdarkgray}}
\newcommand{\yellowtext}{\textcolor{yellow2}}
\newcommand{\blacktext}{\textcolor{black}}

\newcommand{\bc}{\textcolor{darkgreen}}    % bibliography color
\newcommand{\mc}{\textcolor{luigiblue}}    % math color
\newcommand{\tc}{\textcolor{teal}}         % color to highlight parts of the text
\newcommand{\oc}{\textcolor{finsburyblue}} % same color as slide titles

 \everymath{\color{luigiblue}}    % automatically color all math symbols
%\everydisplay{\color{luigiblue}} % automatically color all equations (gives some problems)

% Apply color to specific display math environments
\AtBeginEnvironment{equation}{\color{luigiblue}}
\AtBeginEnvironment{equation*}{\color{luigiblue}}
\AtBeginEnvironment{align}{\color{luigiblue}}
\AtBeginEnvironment{align*}{\color{luigiblue}}
\AtBeginEnvironment{eqnarray}{\color{luigiblue}}
\AtBeginEnvironment{eqnarray*}{\color{luigiblue}}

\newcommand{\remph}{\colorbox{myred}}
\newcommand{\gemph}{\colorbox{mygreen}}
\newcommand{\bemph}{\colorbox{emphblue}}
\newcommand{\yemph}{\colorbox{myyellow}}
\newcommand{\wemph}{\colorbox{white}}
%\newcommand{\bkemph}{\colorbox{black}}
\newcommand{\bkemph}{\colorbox{gray!20}}

\newcommand{\jpm}[1]{{\medskip\noindent\color{blue}\footnotesize\textsc{Josep} $\rightarrow$ #1}\medskip}
 
% Package for using FiraSans font
\usepackage[sfdefault,scaled=.9,light,medium]{FiraSans}
   % Options for regular face: book, light, extralight, ultralight, thin 
   % Options for bold face: medium, semibold, extrabold, heavy
%\makeatletter
%\def\bfseries@sf{m}
...
%   \raisebox{5pt}{\makebox[\paperwidth]{\hfill\makebox[10pt]{\scriptsize\insertframenumber}}}}
   ...
   \setbeamertemplate{footline}
    {\begin{beamercolorbox}[sep=1ex]{author in head/foot}
      \rlap{\textsc{\insertshorttitle}}\hfill\hfill\llap{\insertframenumber}%
      \end{beamercolorbox}%
}
...
\leftmargini   1.25em
\leftmarginii  1.25em
\leftmarginiii 1.25em
\setbeamersize{text margin left=7mm, text margin right=7mm}


% -----------------------------------------------------------------------------
% -- Beamer-specific styles and commands --------------------------------------
% -----------------------------------------------------------------------------

\mode<presentation>
{

%  \usetheme[addhead, addsubsection ,whitehf]{Finsbury}
%  \usetheme[addhead ,whitehf,addfoot,addpage]{Madrid}
   \usetheme[addhead, addsubsection, addfoot, addpage, whitehf, addcolors, smallcaps, forcefonts]{Finsbury}
%  \usetheme[addhead, addfoot, addpage ,whitehf]{Finsbury}  
%  \usetheme[addhead,whitehf,highlighttitles,simplecolors]{Finsbury}
%  \usetheme[addhead,addsubsection,addfoot,addpage]{Finsbury}

% -------- Options of theme Finsbury ---------------------------------------------------------------
%
% (1) addhead ---> adds header to slides
% (2) addfoot ---> adds footer to slides
% (3) addsubsection ---> adds subsections in header
% (4) addpage ---> adds slide number in footer
% (5) whitehf ---> makes background of header and footer white
% (6) simplecolors --->
% (7) highlighttitles ---> colors the background of slide titles in color
% (8) smallcaps ---> uses small caps in frame title and subtitle
% (9) addcolors ---> uses "finsburyblue" color, which needs to be defined in preamble of tex file.
% (10) forcefonts ---> forces the use of the same fonts of the document for the frametitle and foot 
%
% -------------------------------------------------------------------------------------------------
...
%\setbeamertemplate{navigation symbols}{}  % the exact elements in the navigation bar can be chosen
                                           % empty brackets eliminates the bar

%\setbeamertemplate{navigation symbols}{\insertframenavigationsymbol,\insertbackfindforwardnavigationsymbol}
 \setbeamertemplate{navigation symbols}{}

%\setbeamercolor{background canvas}{bg=yellow!05}  % It establishes the color of the background canvas
...
% -----------------------------------------------------------------------------
% -- Title page and outline options ---- --------------------------------------
% -----------------------------------------------------------------------------

\title{Chapter I: Gross Domestic Product}

\author[Bueren]{Jes\'{u}s Bueren \vspace{0.5cm}}

\institute[Cat\'{o}lica-Lisbon ] % (optional, but mostly needed)
{

\nhso Cat\'{o}lica-Lisbon   

}

\date{ \\  \vspace{0.6cm}  {\footnotesize  2025-2026}}
...
\definecolor{lightblue}{rgb}{0.3, 0.5, 0.55}
\definecolor{lightblue}{rgb}{0.3, 0.5, 0.55}
\definecolor{colormodel}{rgb}{0.3, 0.5, 0.55}
